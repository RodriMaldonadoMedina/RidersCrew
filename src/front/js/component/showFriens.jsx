...
export const ShowFriends = (props) => {
  ...
  return (
    <div className="finderCard d-flex justify-content-between my-2">
      <div className="d-flex">
        <img className="search_picture align-self-center" src={item.profilePicture} />
        <div className="text-secondary ms-2">{`${item.friend_name} ${item.friend_last_name}`}</div>
      </div>
